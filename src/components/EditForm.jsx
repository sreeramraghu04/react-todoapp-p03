  ...
  return (
    <div className="text-black">
      <form onSubmit={handlesubmit} action="">
        ...
        //* The onSubmit={handleSubmit} ensures React handles the submission instead of default browser behavior.
        <div
          className={`${
          ...
          //* Uses template literals ({} inside className) to change styles dynamically.todo.done checks whether the task is completed:
          // If true, background is green (bg-green-600).
